...
# useful tools for writing and research
...
## apps for research: references, literature review, idea mapping, note-taking, writing, editing
...
- [ResearchRabbit](https://researchrabbitapp.com/) for finding connected papers
- [Coggle.it](https://coggle.it/) mindmapping web app for structured thinking
...
## workflow tutorials
- [**more resources for using zotero & obsidian for research**](/zotero-obsidian/)
...
### Creating A Research Space (CARS) template for outlining papers, abstracts etc.
